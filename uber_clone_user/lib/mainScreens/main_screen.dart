...
import 'package:uber_clone_user/assistants/assistant_methods.dart';
import 'package:uber_clone_user/assistants/geofire_assistant.dart';
import 'package:uber_clone_user/global/global.dart';
import 'package:uber_clone_user/infoHandler/app_info.dart';
import 'package:uber_clone_user/mainScreens/rate_driver_sc.dart';
import 'package:uber_clone_user/mainScreens/search_places_screen.dart';
import 'package:uber_clone_user/mainScreens/select_nearest_active_driver_screen.dart';
import 'package:uber_clone_user/models/active_nearby_available_drivers.dart';
import 'package:uber_clone_user/widgets/my_drawer.dart';
import 'package:uber_clone_user/widgets/navigation.dart';
      ...
      if((eventSnap.snapshot.value as Map)["driverLocation"] != null)
      {
        ...
        if(userRideRequestStatus == "ended")
        {
          ...
          var response=await showDialog(
            ...
            builder: (context) => PayFareAmount( fareAmount) );
            if(response=='cash paied'){
               if((eventSnap.snapshot.value as Map)["driverId"] != null){
                String driverId=(eventSnap.snapshot.value as Map)["driverId"].toString();
                GoPage().pushNavigation(context, path: RatingSC(driverId));
               }
            }
          }
        }
